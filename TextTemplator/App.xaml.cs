...
using TextTemplator.ViewModel;

namespace TextTemplator
{
    public partial class App : Application
    {
        ...
        public static void ShowMessage(string Title, string Message, Action TapEvent)
        {
        ...
        private void CheckAndCopyLogo()
        {
            using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
            {
                ...
                string isoFile = "Shared/ShellContent/Background.png";
        ...
        {
            var templates = SimpleIoc.Default.GetInstance<MainViewModel>().Templates;
            ISettings.Set("TheTemplates", templates);
        }
